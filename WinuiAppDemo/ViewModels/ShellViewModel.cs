...
/// <summary>
/// Provides functionality for the main shell view model of the application.
/// </summary>
public partial class ShellViewModel : ObservableObject
{
    ...
    public ShellViewModel(IOptions<AppSettings> options, IClockService clockService, INavigationService navigationService, ISettingsService settingsService)
    {
